...
public class GetPageStats : NSObject, IReturn
{
...
// @DataContract
public class Authenticate : NSObject, IReturn, IPost
{
...
// @Route("/assignroles")
// @DataContract
public class AssignRoles : NSObject, IReturn, IPost
{
...
// @Route("/unassignroles")
// @DataContract
public class UnAssignRoles : NSObject, IReturn, IPost
{
...
// @DataContract
public class ConvertSessionToToken : NSObject, IReturn, IPost
{
...
public class GetPageStatsResponse : NSObject
{
    required public override init(){}
    public var type:String?
    public var slug:String?
...
// @DataContract
public class ConvertSessionToTokenResponse : NSObject
{
    required public override init(){}
    // @DataMember(Order=1)
    public var meta:[String:String] = [:]
